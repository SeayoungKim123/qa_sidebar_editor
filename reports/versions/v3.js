...
window.QA_DATA = {
  meta: {
    ...
    updated_at: "2026-06-10 13:48",
    title_suffix: "· 1회차 사이클 완료 (5시나리오 / 23 TC · 22P·1F · 96%)",
  },
  ...
  kpis: {
    ...
    fail: 1,
    open_issues: 5,
    issues_breakdown: "칩 연결오류·응답지연 1 · 모델한도·가용성 1 · 직역치환 비문 1 · 본문 가이드메모 혼입 1 · 인사말중복·끝문장깨짐 1",
    scenario_count: 5,
    tc_count: 23,
  },
